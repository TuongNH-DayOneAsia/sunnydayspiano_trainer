...
import 'package:myutils/utils/list_view_helper/my_paging_scroll_physics.dart';

class MyDotsPagingListView extends StatelessWidget {
  // final double widthDimension;
  final int itemCount;
  final Widget Function(int index) builder;
  final int numberDots;
  final ScrollController imagesController = ScrollController();
  MyDotsPagingListView({super.key, required this.builder, this.numberDots = 5, required this.itemCount});
            ...
            child: StatefulBuilder(builder: (context, setState) {
              ...
              return Stack(alignment: Alignment.bottomCenter, children: [
                ListView.builder(
                  ...
                  physics: MyPagingScrollPhysics(itemDimension: constraints.maxWidth),
