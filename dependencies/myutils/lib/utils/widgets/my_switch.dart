...
class MyCustomSwitch extends StatefulWidget {
  ...
  @override
  MyCustomSwitchState createState() => MyCustomSwitchState();
}

class MyCustomSwitchState extends State<MyCustomSwitch> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MyCustomSwitch oldWidget) {
