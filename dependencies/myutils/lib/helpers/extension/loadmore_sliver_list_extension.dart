...
class MyLoadMoreSliverExtention extends StatefulWidget {
  ...
  const MyLoadMoreSliverExtention({
    super.key,
  ...
  @override
  MyLoadMoreSliverExtentionState createState() {
    return MyLoadMoreSliverExtentionState();
  }
}

class MyLoadMoreSliverExtentionState extends State<MyLoadMoreSliverExtention> {
