...
class MyLoadMoreExtention extends StatefulWidget {
  ...
  @override
  MyLoadMoreExtentionState createState() {
    return MyLoadMoreExtentionState();
  }
}

class MyLoadMoreExtentionState extends State<MyLoadMoreExtention> {
  bool _loadingMore = false;
  final PublishSubject<bool> _loadingMoreSubject = PublishSubject<bool>();
  Stream<bool>? _loadingMoreStream;

  MyLoadMoreExtentionState() {
